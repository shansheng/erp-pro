...
import com.pt.modules.sys.entity.DictType;
...
public class DictUtils {
	...
	public static List<DictValue> getSqlList(String sql){
		 List<DictValue> sqlList = null;;
		if (sql!=null&&!sql.equals("")){
			DictValue dictValue = new DictValue();
			dictValue.setSql(sql);
			sqlList = dictTypeService.findListSql(dictValue);
			if (sqlList == null){
