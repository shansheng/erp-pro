 ...
 */
package com.pt.modules.sys.sysmarketview.web;
...
import com.pt.modules.sys.sysmarketview.service.SysMarketViewService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/sysmarketview/sysMarket")
public class SysMarketViewController extends BaseController {
	@Autowired
	private ClientService sysClientService;
	@Autowired
	private SysMarketViewService sysMarketService;
	...
	public String list() {
		return "modules/sys/sysmarketview/sysMarketList";
	}
	@ResponseBody
	...
	public String view(SysMarket sysMarket, Model model) {
		...
		return "modules/sys/sysmarketview/sysMarketView";
	}
	/**
	 * 查看，增加，编辑销售订单下达表单页面
	 */
	...
	public String form(SysMarket sysMarket, Model model) {
		...
		model.addAttribute("SysMarket", sysMarket);
		return "modules/sys/sysmarketview/sysMarketForm";
	}
