 ...
 */
package com.pt.modules.mes.meswo.entity;
 ...
 * @version 2018-06-05
 */
public class MesEwo extends DataEntity<MesEwo> {
	...
	private String itemTypeLabel;		// item_type_lable
	...
	private String ewoStatus;		// 订单状态
	private String ewoStatusLabel;		// ewo_status_lable
	
	public MesEwo() {
		super();
	}

	public MesEwo(String id){
		super(id);
	}
	...
	@ExcelField(title="订单状态", dictType="ewo_status", align=2, sort=18)
