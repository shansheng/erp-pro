 ...
 */
package com.pt.modules.oa.service;
...
import com.pt.common.utils.Collections3;
import com.pt.common.utils.StringUtils;
import com.pt.core.persistence.Page;
import com.pt.core.service.BaseService;
import com.pt.modules.act.service.ActTaskService;
import com.pt.modules.act.utils.ActUtils;
import com.pt.modules.oa.entity.Leave;
import com.pt.modules.oa.entity.TestAudit;
import com.pt.modules.oa.mapper.LeaveMapper;
...
public class LeaveService extends BaseService {
	...
	public List<Leave> findTodoTasks(String userId) {
		...
		for (Task task : tasks) {
			...
			Leave leave = leaveMapper.get(businessKey);
			leave.setTask(task);
			leave.setProcessInstance(processInstance);
	...
	public Page<Leave> find(Page<Leave> page, Leave leave) {
		...
		dataRuleFilter(leave);
		leave.setPage(page);
		page.setList(leaveMapper.findList(leave));
