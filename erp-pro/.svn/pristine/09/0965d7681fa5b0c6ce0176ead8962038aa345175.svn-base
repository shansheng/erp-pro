		...
		<table class="table table-bordered">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<sys:gridselect url="${ctx}/mdsitem/mdsItem/data?itemType=M" id="mdsItemId" name="mdsItemId" value="${matBomTable.mdsItemId}" labelName="mdsItem.itemName" labelValue="${matBomTable.mdsItemName}"
