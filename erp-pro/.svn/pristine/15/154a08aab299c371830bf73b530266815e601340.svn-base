...
$(document).ready(function() {
	$('#workOrderSonTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/workorderson/workOrderSon/data?workOrderId="+$("#workOrderId").val(),
  ...
  function add(){
	   ...
	   window.location = "${ctx}/workorderdetail/workOrderDetail/list?workOrderSonId=" +id+"&workOrderId="+$("#workOrderId").val();
}
...
function view(){
	 ...
	 window.location = "${ctx}/workorderdetail/workOrderDetail/lists?workOrderSonId=" +id+"&workOrderId="+$("#workOrderId").val();
