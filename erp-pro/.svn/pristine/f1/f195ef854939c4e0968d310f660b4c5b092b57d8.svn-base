...
import com.pt.modules.sys.mapper.DictTypeMapper;
import com.pt.modules.sys.mapper.DictValueMapper;
...
public class DictTypeService extends CrudService<DictTypeMapper, DictType> {
	...
	public List<DictValue> findListSql(DictValue dictValue) {
		List<DictValue> list =  dictValueMapper.findListSql(dictValue);
		return list;
	}
	/**
	 * @param dictValue
	...
	public List<DictValue> getByClassify() {
		return dictValueMapper.getByClassify();
	}
