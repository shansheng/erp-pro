...
<html>
<head>
	<title>库房流水记录管理</title>
	<meta http-equiv="Content-type" content="text/html; charset=utf-8">
	<meta name="decorator" content="ani"/>
	<%@ include file="/webpage/include/bootstraptable.jsp"%>
	<%@include file="/webpage/include/treeview.jsp" %>
	<%@include file="wmsMainRecordList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">库房流水记录列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="wmsMainRecord" class="form form-horizontal well clearfix">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				...
				<form:select path="state"  class="form-control m-b">
					...
					<form:options items="${fns:getDictList('wms_main_storage_vs')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
			 <div class="col-xs-12 col-sm-6 col-md-4">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<%-- <shiro:hasPermission name="wms:wmsmainstoragevs:wmsMainRecord:add">
			...
			<shiro:hasPermission name="wms:wmsmainstoragevs:wmsMainRecord:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="wms:wmsmainstoragevs:wmsMainRecord:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/wms/wmsmainstoragevs/wmsMainRecord/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="wmsMainRecordTable"   data-toolbar="#toolbar"></table>
