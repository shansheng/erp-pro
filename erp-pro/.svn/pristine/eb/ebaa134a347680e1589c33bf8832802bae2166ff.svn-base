 ...
 */
package com.pt.modules.work.workorderson.entity;
 ...
 * @version 2018-10-13
 */
public class WorkOrderSon extends DataEntity<WorkOrderSon> {
	...
	private String shipmentsState; //发货状态
