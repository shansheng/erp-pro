...
<head>
	...
	<%@include file="mdsPurchaseListList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">批量采购计划列表</h3>
	</div>
				 ...
				 <div class="form-group">
					...
					<div class="col-xs-12">
						   <div class="col-xs-15 col-sm-5">
					            <!-- <input type="date" name="beginDemandDate" id="beginDemandDate"  class="form-control"/> -->
					         <div class='input-group date' id='beginDemandDate' style="left: -10px;" >
					                   <input type='text'  name="beginDemandDate" class="form-control"  />
					        ...
					        <div class="col-xs-15 col-sm-5">
					        <!-- <input type="date" name="endDemandDate" id="endDemandDate"  class="form-control"/> -->
					          	 <div class='input-group date' id='endDemandDate' style="left: -10px;" >
					                   <input type='text'  name="endDemandDate" class="form-control" />
					                   <span class="input-group-addon">
					                       <span class="glyphicon glyphicon-calendar"></span>
					                   </span>
					           	</div>	
	...
	<div id="toolbar">
			...
			<shiro:hasPermission name="mds:purchase:mdsPurchaseList:addPurchase">
				<button id="addPurase" class="btn btn-primary"  disabled onclick="addPurase()"  >
				<i class="glyphicon glyphicon-plus"></i> 添加到采购计划
				</button>
			</shiro:hasPermission>
