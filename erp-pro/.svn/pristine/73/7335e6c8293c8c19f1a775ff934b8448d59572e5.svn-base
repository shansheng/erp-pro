 ...
 */
package com.pt.modules.work.workorderdetail.entity;
 ...
 * @version 2018-10-13
 */
public class WorkOrderDetail extends DataEntity<WorkOrderDetail> {
	...
	private WorkOrderDetail parent;		// parent_id
	...
	public WorkOrderDetail getParent() {
		return parent;
	}
	public void setParent(WorkOrderDetail parent) {
		this.parent = parent;
	}
	...
	public WorkOrderDetail(WorkOrderSon workOrderSon){
