...
public class SystemService extends BaseService implements InitializingBean {
	...
	public Page<User> findUsersByIds(Page<User> page, User user,String ids) {
		dataRuleFilter(user);
		// 设置分页参数
		user.setPage(page);
		// 执行分页查询
		page.setList(userMapper.findUsersByIds(user,ids));
		return page;
	}
