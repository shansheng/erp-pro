...
<head>
	...
	<%@include file="mdsReplaceItemApply.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">代料申请</h3>
	</div>
	...
	<%-- 		<shiro:hasPermission name="mds:mdsProcurementPlan:edit">
			...
			<shiro:hasPermission name="mds:mdsrepalceitem:mdsReplaceItem:apply">
				<button id="collect" class="btn btn-info" onclick="collectAll()">
	            	<i class="glyphicon glyphicon-zoom-in"></i> 汇总显示
	        	</button>
			</shiro:hasPermission> --%>
			<shiro:hasPermission name="mds:mdsrepalceitem:mdsReplaceItem:apply">
			    <button id="apply" class="btn btn-success" disabled onclick="apply()">
	            	<i class="glyphicon glyphicon-ok"></i> 申请代料
	        	</button>
			</shiro:hasPermission>
