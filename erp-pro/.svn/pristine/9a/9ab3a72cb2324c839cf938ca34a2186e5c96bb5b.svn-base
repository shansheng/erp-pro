...
<head>
	...
	<%@include file="templanDepartmentList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">部门领导审核列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="templanDepartment" class="form form-horizontal well clearfix">
			...
			<div class="col-xs-12 col-sm-6 col-md-4">
				...
				<form:input path="createBy.name" htmlEscape="false" maxlength="100"  class=" form-control"/>
			</div>
			<div class="col-xs-12 col-sm-6 col-md-4">
	...
	<div id="toolbar">
			...
			<shiro:hasPermission name="templan:templandepartment:templanDepartment:add">
				<button id="opinion" class="btn btn-warning" disabled onclick="doAssessing()">
	            	<i class="glyphicon glyphicon-plus"></i> 同意
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="templan:templandepartment:templanDepartment:reject">
			    <button id="reject" class="btn btn-danger" disabled onclick="doReject()">
	            	<i class="glyphicon glyphicon-remove"></i> 驳回
	        	</button>
			</shiro:hasPermission>
			<%-- <shiro:hasPermission name="templan:templandepartment:templanDepartment:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission> --%>
			<shiro:hasPermission name="templan:templandepartment:templanDepartment:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/templan/templandepartment/templanDepartment/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="templanDepartmentTable"   data-toolbar="#toolbar"></table>
