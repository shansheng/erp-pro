		...
		<table class="table table-bordered">
			<tbody>
				...
				<tr>
					...
					<td class="width-15 active"><label class="pull-right">尚欠余额：</label></td>
					<td class="width-35"><form:input path="debt"
							htmlEscape="false" disabled="true" class="form-control required" />
					</td>
				...
				<td class="width-15 active"><label class="pull-right">备注：</label></td>
					...
					<textarea   name="remake" disabled="disabled" style="resize:none;margin: 0px; height: 91px; width: 635px;"></textarea>
