 ...
 * @version 2018-09-05
 */
public class TemplanDepartmentList extends DataEntity<TemplanDepartmentList> {
	...
	public TemplanDepartmentList() {
		super();
	}

	public TemplanDepartmentList(String id){
		super(id);
	}

	public TemplanDepartmentList(TemplanDepartment temporaryPlanId){
