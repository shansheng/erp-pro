 ...
 */
package com.pt.modules.sys.sysmarketall.web;
...
import com.pt.modules.sys.sysmarketall.service.SysMarketAllService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/sysmarketall/sysMarket")
public class SysMarketAllController extends BaseController {
	@Autowired
	private ClientService sysClientService;
	@Autowired
	private SysMarketAllService sysMarketService;
	 ...
	 * 销售订单下达列表页面
	 */
	@RequiresPermissions("SysMarketAll:sysMarket:list")
	@RequestMapping(value = {"list", ""})
	public String list() {
		return "modules/sys/sysmarketall/sysMarketList";
	}
	@ResponseBody
	 ...
	 * 查看，增加，编辑销售订单下达表单页面
	 */
	@RequiresPermissions(value={"SysMarketAll:sysMarket:view","SysMarket:sysMarket:add","SysMarket:sysMarket:edit"},logical=Logical.OR)
	...
	public String form(SysMarket sysMarket, Model model) {
		...
		return "modules/sys/sysmarketall/sysMarketForm";
	}
	...
	public String view(SysMarket sysMarket, Model model) {
		...
		model.addAttribute("SysMarket", sysMarket);
		return "modules/sys/sysmarketall/sysMarketView";
	}
	/**
	 * 保存销售订单下达
	 */
