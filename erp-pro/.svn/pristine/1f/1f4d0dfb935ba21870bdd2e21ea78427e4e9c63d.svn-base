...
<%@include file="mrpWoFeedingList.js"%>
</head>
<body>
	<div class="wrapper wrapper-content">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">任务查询列表</h3>
			</div>
			<div class="panel-body">
				...
				<div class="accordion-group">
					<div id="collapseTwo" class="accordion-body collapse">
						<div class="accordion-inner">
							<form:form id="searchForm" modelAttribute="mrpWoFeeding"
								class="form form-horizontal well clearfix">
								<div class="col-xs-12 col-sm-6 col-md-4">
									<label class="label-item single-overflow pull-left"
										title="工作订单号，编号规则为WO-YYMMAAA，即WO-,加上两位年的数字，两位月的数字和三位流水号：">工作订单号：</label>
								...
								<!-- <div class="form-group"> -->
									...
									<div class="col-xs-12">
										<div class='input-group date' id='planStartDate' style="left: -10px;" >
					                   <input type='text'  name="planStartDate" class="form-control"  />
								...
								<!-- <div class="form-group"> -->
									...
									<div class="col-xs-12">
										<div class='input-group date' id='planEndDate' style="left: -10px;" >
				...
				<div id="toolbar">
				<%-- 
					<shiro:hasPermission name="mrpwofind:mrpWoFeeding:add">
					...
					<shiro:hasPermission name="mrpwofind:mrpWoFeeding:del">
						<button id="remove" class="btn btn-danger" disabled
							onclick="deleteAll()">
							<i class="glyphicon glyphicon-remove"></i> 删除
						</button>
					</shiro:hasPermission>
					<shiro:hasPermission name="mrpwofind:mrpWoFeeding:import">
						<button id="btnImport" class="btn btn-info">
							<i class="fa fa-folder-open-o"></i> 导入
						</button>
						<div id="importBox" class="hide">
							<form id="importForm"
								action="${ctx}/mrpwofind/mrpWoFeeding/import" method="post"
				...
				<!-- 表格 -->
				<table id="mrpWoFeedingTable" data-toolbar="#toolbar"></table>
