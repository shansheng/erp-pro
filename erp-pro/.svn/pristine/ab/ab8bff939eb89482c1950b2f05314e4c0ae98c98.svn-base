...
<head>
	...
	<%@include file="workOrderReturList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">车间计划列表</h3>
	</div>
...
<!-- 搜索 -->
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="workOrderRetur" class="form form-horizontal well clearfix">
	...
	<div id="toolbar">
			...
			<shiro:hasPermission name="workorderson:workOrderSon:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 填写工作进度
	        	</button>
			</shiro:hasPermission>
