...
CKFinder.lang['nl'] =
{
	...
	ErrorMsg :
	{
		...
		PopupBlockView	: 'Het was niet mogelijk om dit bestand in een nieuw venster te openen. Configureer de browser zodat het de popups van deze pt niet blokkeert.',
