 ...
 */
package com.pt.modules.test.entity.onetomanydialog;
...
public class TestDataChild11 extends DataEntity<TestDataChild11> {
	...
	private TestDataMainDialog testDataMain;		// 业务主表ID 父类
	...
	public TestDataChild11(TestDataMainDialog testDataMain){
