...
<head>
	...
	<%@include file="mdsReplaceItemApprove.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">代料审批</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			...
			<%--  <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="申批状态：">申批状态：</label>
				<form:input path="replaceState" htmlEscape="false" maxlength="64"  class=" form-control"/>
			</div> --%>
			 <div class="col-xs-12 col-sm-6 col-md-4">
	...
	<div id="toolbar">
		<%-- 	<shiro:hasPermission name="mds:mdsrepalceitem:mdsReplaceItem:add">
			...
			<shiro:hasPermission name="mds:mdsrepalceitem:mdsReplaceItem:agree">
			     <button id="approve" class="btn btn-success" disabled onclick="approve()">
			        <i class="glyphicon glyphicon-edit"></i>同意
			     </button>
			</shiro:hasPermission>
				<shiro:hasPermission name="mds:mdsrepalceitem:mdsReplaceItem:reject">
