...
$(document).ready(function() {
	$('#workOrderDetailTable').bootstrapTable({
			...
			,{
		        ...
		        formatter:function(value,row,index){
		         ...
		         if(value == null ){
		        	...
		        	return "<input type='date' name='planEndDate' id='planEndDate"+row.id+"' disabled='disabled' class='form-control' value='"+planEndDate+"' onchange='change("+index+")'>";
	  ...
	  $('#workOrderDetailTable').on('check.bs.table uncheck.bs.table load-success.bs.table ' +
            ...
            $('#edit').prop('disabled', $('#workOrderDetailTable').bootstrapTable('getSelections').length!=1||$('#workOrderDetailTable').bootstrapTable('getSelections')[0].planStartDate!=null);
        });
