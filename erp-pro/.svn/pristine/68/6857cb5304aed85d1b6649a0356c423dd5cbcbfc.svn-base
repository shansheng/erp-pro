 ...
 */
package com.pt.modules.test.web.manytomany;
...
import com.pt.modules.test.service.manytomany.CourseService;
...
public class CourseController extends BaseController {
	...
	public String form(Course course, Model model) {
		...
		if(StringUtils.isBlank(course.getId())){//如果ID是空为添加
	...
	public String save(Course course, Model model, RedirectAttributes redirectAttributes) throws Exception{
		...
		return "redirect:"+Global.getAdminPath()+"/test/manytomany/course/?repage";
	}
	...
	public AjaxJson delete(Course course, RedirectAttributes redirectAttributes) {
    ...
    public AjaxJson exportFile(Course course, HttpServletRequest request, HttpServletResponse response, RedirectAttributes redirectAttributes) {
		AjaxJson j = new AjaxJson();
		try {
