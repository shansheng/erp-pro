...
<div class="wrapper wrapper-content">
	...
	<div class="panel-heading">
			...
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/mds/mdsquota/mdsQuota?clientId=+${mdsQuotaDetail.clientId}+&mdsItemCode=+${mdsQuotaDetail.mdsItemCode}+&mdsItemName=+${mdsQuotaDetail.mdsItemName}+&state=+${mdsQuotaDetail.state}"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		...
		<form:form id="searchForm" modelAttribute="mdsQuotaDetail" class="form form-horizontal well clearfix">
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
						<label class="label-item single-overflow pull-left" title="校验人：">校验人：</label>
						<form:input path="verifyBy" htmlEscape="false" maxlength="100" class=" form-control" />
				</div>
		 <div class="col-xs-12 col-sm-6 col-md-4">
	...
	<div id="toolbar">
			...
			<shiro:hasPermission name="mds:mdsquota:mdsQuota:import">
				...
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/mds/mdsquota/mdsQuotaDetail/import?id=${mdsQuotaDetail.id}" method="post" enctype="multipart/form-data"
							 style="padding-left:20px;text-align:center;" ><br/>
							<input id="uploadFile" name="file" type="file" style="width:330px"/>导入文件不能超过5M，仅允许导入“xls”或“xlsx”格式文件！<br/>　　
						</form>
						<!-- <iframe name="name" style="dispaly: none"></iframe> -->
				</div>
			</shiro:hasPermission>
