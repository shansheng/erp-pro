...
<head>
	...
	<%@include file="testTemporaryPlanList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">临时计划申请表列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="testTemporaryPlan" class="form form-horizontal well clearfix">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="templan:testTemporaryPlan:add">
			...
			<shiro:hasPermission name="templan:testTemporaryPlan:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="templan:testTemporaryPlan:doSubmit">
				<button id="doSubmit" class="btn btn-warning" disabled onclick="doSubmit()">
	            	<i class="glyphicon glyphicon-plus"></i> 提交
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="templan:testTemporaryPlan:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/templan/testTemporaryPlan/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="testTemporaryPlanTable"   data-toolbar="#toolbar"></table>
