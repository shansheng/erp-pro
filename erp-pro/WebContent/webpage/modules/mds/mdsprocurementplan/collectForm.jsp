...
$(document).ready(function() {
	$('#table').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/mds/mdsProcurementPlan/collectAllDate",
...
<body class="bg-white">
	...
	<form:form id="searchForm"  class="form form-horizontal well clearfix" modelAttribute="collect">
		<div class="hide">
			...
			<%-- <form:input path="pcmBeginRequiredDate" htmlEscape="false" maxlength="100"  class=" form-control"/> --%>
			...
			<%-- <form:input path="pcmEndRequiredDate" htmlEscape="false" maxlength="100"  class=" form-control"/> --%>
			...
			<form:input path="pcmState" htmlEscape="false" maxlength="100"  class=" form-control"/>
