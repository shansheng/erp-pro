...
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="mdsItem" class="form form-horizontal well clearfix">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				...
				<form:select path="sourceType"  class="form-control m-b">
					<form:option value="" label="请选择"/>
					<form:options items="${fns:getDictList('source_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
			<%--  <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="sys_office_id 组织机构id：">部门：</label>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="mdsitem:mdsItem:add">
			...
			<shiro:hasPermission name="mdsitem:mdsItem:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="mdsitem:mdsItem:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/mdsitem/mdsItem/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="mdsItemTable"   data-toolbar="#toolbar"></table>
