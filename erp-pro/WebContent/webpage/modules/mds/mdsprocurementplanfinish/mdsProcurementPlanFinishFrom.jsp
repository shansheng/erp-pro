...
<body class="bg-white">
		<form:form id="inputForm" modelAttribute="mdsProcurementPlanFinish" action="${ctx}/mds/mdsarrivalaffirm/mdsArrivalAffirm/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<div class='input-group form_datetime' id='requiredDate'>
							<input type='text' name="requiredDate" class="form-control" value="<fmt:formatDate value="${mdsProcurementPlanFinish.requiredDate}" pattern="yyyy-MM-dd"/>" readonly="true"/>
				...
				<tr>
					...
					<td class="width-35">
						<%-- <form:input path="finishState" htmlEscape="false"    class="form-control " readonly="true"/> --%>
						<form:select path="finishState"
							class="form-control" readonly="true">
							<form:option value="" label="---请选择---" />
							<form:options items="${fns:getDictList('procurement_finish_state')}"
		...
		<div class="tabs-container">
			...
			<script type="text/template" id="mdsArrivalCheckoutTpl">//<!--
				<tr id="mdsArrivalCheckoutList{{idx}}">
					...
					<td>
						<input id="mdsArrivalCheckoutList{{idx}}_createBy.name" name="mdsArrivalCheckoutList[{{idx}}].createBy.name" type="text" value="{{row.createBy.name}}"    class="form-control " readonly="readonly"/>
					</td>
					<td>
						<input id="mdsArrivalCheckoutList{{idx}}_createDate" name="mdsArrivalCheckoutList[{{idx}}].createDate" type="text" value="{{row.createDate}}"    class="form-control " readonly="readonly"/>
					</td>

					<td>
						<input id="mdsArrivalCheckoutList{{idx}}_qualified" name="mdsArrivalCheckoutList[{{idx}}].arrivalNum" type="text" value="{{row.qualified}}"    class="form-control " readonly="readonly"/>
					</td>
					<td>
						<input id="mdsArrivalCheckoutList{{idx}}_disqualification" name="mdsArrivalCheckoutList[{{idx}}].disqualification" type="text" value="{{row.disqualification}}"    class="form-control " readonly="readonly"/>
					</td>
					<td>
						<input id="mdsArrivalCheckoutList{{idx}}_updateBy.name" name="mdsArrivalCheckoutList[{{idx}}].updateBy.name" type="text" value="{{row.updateBy.name}}"    class="form-control " readonly="readonly"/>
					</td>
					<td>
						<input id="mdsArrivalCheckoutList{{idx}}_updateDate" name="mdsArrivalCheckoutList[{{idx}}].updateDate" type="text" value="{{row.updateDate}}"    class="form-control " readonly="readonly"/>
					</td>
					
					<td>
						<input id="mdsArrivalCheckoutList{{idx}}_inStorage" name="mdsArrivalCheckoutList[{{idx}}].inStorage" type="text" value="{{row.inStorage}}"    class="form-control " readonly="readonly"/>
					</td>
					<td>
						<input id="mdsArrivalCheckoutList{{idx}}_inStorageBy.name" name="mdsArrivalCheckoutList[{{idx}}].inStorageBy.name" type="text" value="{{row.inStorageBy.name}}"    class="form-control " readonly="readonly"/>
					</td>
					<td>
						<input id="mdsArrivalCheckoutList{{idx}}_inStorageDate" name="mdsArrivalCheckoutList[{{idx}}].inStorageDate" type="text" value="{{row.inStorageDate}}"    class="form-control " readonly="readonly"/>
					</td>

					<td>
						<input id="mdsArrivalCheckoutList{{idx}}_checkoutState" name="mdsArrivalCheckoutList[{{idx}}].checkoutState" type="text" value="{{row.checkoutState}}"    class="form-control " readonly="readonly"/> 
					</td>
				</tr>//-->
			</script>
			<script type="text/javascript">
				...
				$(document).ready(function() {
					var data = ${fns:toJson(mdsProcurementPlanFinish.mdspcmplanfinishlist)};
