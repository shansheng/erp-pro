...
<body>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="sysmarket:sysMarket:add">
				<a id="add" class="btn btn-primary" onclick="add()"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
		
			<shiro:hasPermission name="sysmarket:sysMarket:export">
			     <button id="btnExport" class="btn btn-info"><i class="fa fa-folder-open-o"></i>导出</button>
			</shiro:hasPermission>
