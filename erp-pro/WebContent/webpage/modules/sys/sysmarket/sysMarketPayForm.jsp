	...
	<form:form id="inputForm" modelAttribute="sysMarket"
		...
		<table class="table table-bordered">
			<tbody>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right"><font
							color="red">*</font>还款(万)：</label></td>
					<td class="width-35"><form:input path="totalPay" 
							htmlEscape="false" onkeyup="value=value.replace(/[^\d.]/g,'')"
							class="form-control required" /></td>
					<td class="width-15 active"><label class="pull-right"><font
							color="red">*</font>尚欠余额(万)：</label></td>
				...
				<tr>
				   <td class="width-15 active"><label class="pull-right">回款记录:</label></td>
				   <td class="width-35" colspan="3">
				      <textarea name="retPayRecord" style="resize:none;margin: 0px; height: 50px; width: 635px;">${sysMarket.retPayRecord}</textarea>
				   </td>
				</tr>
				<tr>
...
//<!--
				<tr id="sysMarketListList{{idx}}">
					...
					<td >
<input id="sysMarketListList{{idx}}_mdsItem" name="mdsItem.name" type="text" value="{{row.itemName}}"    class="form-control " readonly="true"/>
