		...
		<table class="table table-bordered">
			<tbody>
				...
				<tr>
					...
					<td class="width-35">
					<input type="date" name="skillStartDate" id="SkillStartDate" onchange="dateCheck('SkillStartDate')" class="form-control required"  value="<fmt:formatDate value="${sysmarketmilestone.skillStartDate}" pattern="yyyy-MM-dd"/>"> 
					...
					<td class="width-35">
					<input type="date" name="skillEndDate" id="SkillEndDate" onchange="dateCheck('SkillEndDate')" class="form-control required"  value="<fmt:formatDate value="${sysmarketmilestone.skillEndDate}" pattern="yyyy-MM-dd"/>"> 
				...
				<tr>
					...
					<td class="width-35">
					<input type="date" name="purchaseStartDate" id="purchaseStartDate" onchange="purdateCheck('purchaseStartDate')" class="form-control required"  value="<fmt:formatDate value="${sysmarketmilestone.purchaseStartDate}" pattern="yyyy-MM-dd"/>"> 
						
					</td>
					<td class="width-15 active"><label class="pull-right"><font
							color="red">*</font>采购完成时间：</label></td>
					<td class="width-35">
										<input type="date" name="purchaseEndDate" onchange="purdateCheck('purchaseEndDate')" id="purchaseEndDate" class="form-control required"  value="<fmt:formatDate value="${sysmarketmilestone.purchaseEndDate}" pattern="yyyy-MM-dd"/>"> 
				...
				<tr>
					...
					<td class="width-35">
										<input type="date" name="productionStartDate" onchange="prodateCheck('productionStartDate')" id="productionStartDate" class="form-control required"  value="<fmt:formatDate value="${sysmarketmilestone.productionStartDate}" pattern="yyyy-MM-dd"/>"> 
						
					</td>
					<td class="width-15 active"><label class="pull-right"><font
							color="red">*</font>生产结束时间：</label></td>
					<td class="width-35">
										<input type="date" name="productionEndDate" onchange="prodateCheck('productionEndDate')" id="productionEndDate" class="form-control required"  value="<fmt:formatDate value="${sysmarketmilestone.productionEndDate}" pattern="yyyy-MM-dd"/>"> 
...
//<!--
				<tr id="sysMarketListList{{idx}}">
					...
					<td ><sys:itemSelectForForm url="${ctx}/mdsitem/mdsItem/data?itemType=G" id="sysMarketListList{{idx}}_mdsItem" name="sysMarketListList[{{idx}}].mdsItemId" value="{{row.mdsItemId}}" labelName="mdsItem.itemName" labelValue="{{row.itemName}}"
