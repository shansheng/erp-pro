...
<script type="text/javascript">
											...
											top.layer
													.open({
														...
														yes : function(index,
															...
															$
																	.ajax({
																		url : "${ctx}/sysmarketview/sysMarket/getClient",
																		data : {
																			clientId : clientId
																		},
																		success : function(
	...
	function checkNo(){
		...
		jp.get("${ctx}/sysmarket/sysMarket/checkNo?contractNo=" + No, function(data){
   	  		if(data.success){
		...
		<table class="table table-bordered">
			<tbody>
				...
				<tr>
					...
					<td class="width-35"><input id="contractNo" name="contractNo" onblur="checkNo()"
							 class="form-control required" /></td>
							<td class="width-15 active"><label class="pull-right"><font
							color="red">*</font>是否发货：</label></td>
					<td class="width-35" ><form:select path="shipments"
				...
				<tr>
					...
					<td class="width-35"><form:select path="contractClass"
							class="form-control required">
...
//<!--
				<tr id="sysMarketListList{{idx}}">
					...
					<td>
						<input id="sysMarketListList{{idx}}_num" name="sysMarketListList[{{idx}}].num" type="text" value="{{row.num}}"    class="form-control required number"/>
					</td>
