...
<body>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="systemmarket:sysMarket:add">
				<a id="add" class="btn btn-primary" onclick="add()"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
		
			
				
			<shiro:hasPermission name="systemmarket:sysMarket:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/systemmarket/sysMarket/import" method="post" enctype="multipart/form-data"
