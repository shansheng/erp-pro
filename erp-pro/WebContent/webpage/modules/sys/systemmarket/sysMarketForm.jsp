		...
		<table class="table table-bordered">
			<tbody>
				...
				<td class="width-15 active"><label class="pull-right">备注：</label></td>
					...
					<textarea   name="remake"  style="resize:none;margin: 0px; height: 91px; width: 635px;"></textarea>
...
//<!--
				<tr id="sysMarketListList{{idx}}">
					...
					<td ><sys:itemSelectForForm url="${ctx}/mdsitem/mdsItem/data?itemType=M" id="sysMarketListList{{idx}}_mdsItem" name="sysMarketListList[{{idx}}].mdsItemId" value="{{row.mdsItemId}}" labelName="mdsItem.itemName" labelValue="{{row.itemName}}"
