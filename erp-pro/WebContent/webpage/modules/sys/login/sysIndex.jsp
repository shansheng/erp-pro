...
<body class="">
	<nav class="navbar topnav-navbar navbar-fixed-top" role="navigation">
		<div class="navbar-header text-center">
			...
			<a class="navbar-brand J_menuItem"  href="${ctx}/home">生产采购管理系统 </a>
		</div>
		<div class="collapse navbar-collapse">
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" onClick="largeScreen()">
						<span class="glyphicon glyphicon-facetime-video"></span>&nbsp;<span>大屏幕看板全屏</span>
					</a>
				</li>
			</ul>
			<ul class="nav navbar-nav pull-right navbar-right">	
				...
				<li class="dropdown admin-dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
						<img src="<c:if test="${fns:getUser().photo == null || fns:getUser().photo==''}">${ctxStatic}/common/images/flat.png</c:if> <c:if test="${fns:getUser().photo != null && fns:getUser().photo!=''}">${fns:getUser().photo}</c:if>" class="topnav-img" alt=""><span class="hidden-sm">${fns:getUser().name}</span>
					</a>
	...
	<div class="sidenav-outer">
		<div class="side-widgets">
			<div class="text-center" style="padding-top:10px;"> 
				<a  href="#"><img class="img-circle user-avatar"  src="<c:if test="${fns:getUser().photo == null || fns:getUser().photo==''}">${ctxStatic}/common/images/flat.png</c:if> <c:if test="${fns:getUser().photo != null && fns:getUser().photo!=''}">${fns:getUser().photo}</c:if>" class="user-avatar" /></a>
...
<section id="body-container" class="animation">
		...
		<div class="main-container" id="main-container">
           ...
           <div class="footer">
                <div class="pull-left">杰瑞深软 &copy; 2017-2027</div>
            </div>
