			 ...
			 <div class="row">
			    ...
			    <div id="toolbar" class="treetable-bar">
			    	<shiro:hasPermission name="sys:menu:add">
						<a id="add" class="btn btn-primary" onclick="jp.openDialog('新建菜单', '${ctx}/sys/menu/form?parent.id={menu.id}','800px', '500px', $treeTable)"><i class="glyphicon glyphicon-plus"></i> 新建菜单</a><!-- 增加按钮 -->
					</shiro:hasPermission>
					<button class="btn btn-warning" data-toggle="tooltip" data-placement="left" onclick="refresh()" title="刷新"><i class="glyphicon glyphicon-repeat"></i> 刷新</button>
			    </div><!-- 工具栏结束 -->
