...
<script type="text/html" id="menuItemTpl">
	<td> <a  href="#" onclick="jp.openDialogView('查看菜单', '${ctx}/sys/menu/form?id={{d.id}}','800px', '500px')"> <i class="{{d.icon}}"></i> {{d.name}}</a></td>
	...
	<td>
		...
		<ul class="dropdown-menu" role="menu">
			<shiro:hasPermission name="sys:menu:view">
				<li><a href="#" onclick="jp.openDialogView('查看菜单', '${ctx}/sys/menu/form?id={{d.id}}','800px', '500px')"><i class="fa fa-search-plus"></i> 查看</a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="sys:menu:edit">
				<li><a href="#" onclick="jp.openDialog('修改菜单', '${ctx}/sys/menu/form?id={{d.id}}','800px', '500px', $treeTable)"><i class="fa fa-edit"></i> 修改</a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="sys:menu:del">
				<li><a  onclick="return del(this, '{{d.id}}')"><i class="fa fa-trash"></i> 删除</a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="sys:menu:add">
				<li><a href="#" onclick="jp.openDialog('添加下级菜单', '${ctx}/sys/menu/form?parent.id={{d.id}}','800px', '500px', $treeTable)"><i class="fa fa-plus"></i> 添加下级菜单</a></li>
			</shiro:hasPermission>
		</ul>
		</div>
