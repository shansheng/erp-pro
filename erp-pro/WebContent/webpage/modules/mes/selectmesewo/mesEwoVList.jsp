...
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="mesEwoV" class="form form-horizontal well clearfix">
			<div class="col-xs-12 col-sm-6 col-md-4">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				...
				<form:input path="proMdsItemCode" htmlEscape="false" maxlength="32"  class=" form-control"/>
			</div>
			 <div class="col-xs-12 col-sm-6 col-md-4">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="selectmesewo:mesEwoV:add">
			...
			<shiro:hasPermission name="selectmesewo:mesEwoV:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="selectmesewo:mesEwoV:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/selectmesewo/mesEwoV/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="mesEwoVTable"   data-toolbar="#toolbar"></table>
